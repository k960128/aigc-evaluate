...
import com.kant.llm.eval.dto.req.CreateRiskVocabularyGroupRequest;
...
import com.kant.llm.eval.dto.req.UpdateRiskVocabularyGroupRequest;
import com.kant.llm.eval.dto.req.UpdateRiskVocabularyKeywordRequest;
import com.kant.llm.eval.dto.resp.RiskVocabularyGroupVO;
...
public class RiskVocabularyController {
    ...
    public Result<RiskVocabularyKeywordVO> createKeyword(@RequestBody CreateRiskVocabularyKeywordRequest request) {
        ...
        BeanUtils.copyProperties(request, entity);
        entity.setSyncStatus(request.getSyncStatus() == null ? 0 : request.getSyncStatus());
