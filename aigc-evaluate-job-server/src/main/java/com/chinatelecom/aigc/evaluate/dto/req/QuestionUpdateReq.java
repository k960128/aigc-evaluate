...
@ApiModel(value = "管理后台 - 题目更新 Request Req")
public class QuestionUpdateReq {
     ...
     * 题目唯一编号
     */
    @ApiModelProperty(value = "题目唯一编号", required = true)
    @NotBlank(message = "题目唯一编号不能为空")
     ...
     * 标签
     */
    @ApiModelProperty(value = "题目标签", required = true)
     ...
     * 攻击方式
     */
    @ApiModelProperty(value = "攻击方式", required = true)
    @NotBlank(message = "攻击方式不能为空")
