...
@ApiModel(value = "管理后台 - 题目创建集合 QuestionSetSaveReq Req")
public class QuestionSetSaveReq {
     ...
     * 评测目标
     */
//    @ApiModelProperty(value = "评测目标", required = true, example = "1024")
//    @NotBlank(message = "评测目标不能为空")
