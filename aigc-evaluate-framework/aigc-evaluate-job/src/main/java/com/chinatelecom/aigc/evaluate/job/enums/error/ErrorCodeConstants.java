package com.chinatelecom.aigc.evaluate.job.enums.error;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode JOB_UPDATE_ONLY_EXECUTING_STATUS = new ErrorCode(1_001_001_008, "只有运行的任务才可以停止");
    ErrorCode JOB_CANNOT_UPDATE_BY_THIS_STATUS = new ErrorCode(1_001_001_008, "当前状态不能修改，请等待停止执行或执行完成");
    // ========== 任务相关 1_002_600_000 ==========
    ErrorCode JOB_NOT_EXISTS_ERROR = new ErrorCode(1_001_001_008, "任务不存在");
    ErrorCode JOB_NAME_EXISTS_ERROR = new ErrorCode(1_001_001_009, "任务名称冲突，请从新命名");
    ErrorCode JOB_ONETIME_EXPRESSION_NOT_EXISTS_ERROR = new ErrorCode(1_001_001_010, "任务一次性执行时间表达式不能为空");
    ErrorCode JOB_ONETIME_EXPRESSION_INVALID_ERROR = new ErrorCode(1_001_001_011, "任务一次性执行时间表达式格式错误");
    ErrorCode JOB_ONETIME_EXPRESSION_PAST_ERROR = new ErrorCode(1_001_001_012, "任务一次性执行时间错误，时间在当前时间之前");
    ErrorCode JOB_EXECUTING_ERROR = new ErrorCode(1_001_001_013, "任务执行失败");
    ErrorCode JOB_IS_EXECUTING = new ErrorCode(1_001_001_014, "任务正在执行");
    ErrorCode JOB_PARAM_ERROR = new ErrorCode(1_001_001_015, "下发任务的参数错误");
    ErrorCode JOB_CANNET_TRIGGER = new ErrorCode(1_001_001_016, "只有手动执行任务可以被触发执行");
    ErrorCode JOB_WAITING_STOP = new ErrorCode(1_001_001_017, "等待上次任务停止");
    ErrorCode JOB_PLEASE_STOP = new ErrorCode(1_001_001_018, "请先停止任务再删除");
